                    ...
                    <nav class="mt-2">
                        ...
                        @else
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                @endcan
                                @if (Auth::user()->can('Vicerrectoria') || Auth::user()->can('administrador'))
                                    <li class="nav-item">
                            ...
                            <div class="position-absolute mb-4"
                                style="bottom: 0%; left: 50%; transform: translate(-50%, 0%);">
                                <a href="{{ route('logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <button class="btn btn-danger" style="width: 125px">Log out</button>
                                </a>
